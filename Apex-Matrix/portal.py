...
# Initialize Session State for Property Comparison
...
# =====================================================================
# 1. COMMERCIAL REAL ESTATE MODULE (WITH PLOTLY & PDF & COMPARISON)
# =====================================================================
if app_choice == "🏢 Commercial Real Estate (HVII Matrix)":
    ...
    with st.expander("💡 Underwriting Guidance & Heuristics"):
        st.write("""
        - **Buffett Margin of Safety**: Triggers when purchase price is 20%+ below intrinsic appraised value.
        - **Monte Carlo Sensitivity**: Simulates yield variances across interest rate fluctuations.
        - **Executive PDF**: Generates a downloadable funding memo for banking committees.
        """)
    ...
    if st.button("Run HVII Evaluation & Sensitivity Analysis", type="primary"):
        ...
        # --- PLOTLY 10-YEAR CASH FLOW PROJECTION ---
        ...
        # --- PLOTLY INTEREST RATE SENSITIVITY ---
    ...
    if "last_evaluation" in st.session_state:
        ...
        if st.button("Download Executive Underwriting Memo (PDF)"):
            pdf = FPDF()
            pdf.add_page()
            ...
            with open(pdf_path, "rb") as f:
                st.download_button("Click here to download PDF file", f, file_name="Apex_Underwriting_Memo.pdf", mime="application/pdf")
...
# =====================================================================
    ...
    st.markdown("All enterprise modules are gated by Gumroad subscriptions, powered by high-performance Python engines, and equipped with live Plotly analytics and PDF export utilities.")
